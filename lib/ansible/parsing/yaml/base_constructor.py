...
class AnsibleBaseConstructor(SafeConstructor):
    def __init__(self, file_name=None):
        self._ansible_file_name = file_name
        super(AnsibleBaseConstructor, self).__init__()
    ...
    def construct_mapping(self, node, deep=False):
        ...
        for key_node, value_node in node.value:
            ...
            if C and key in mapping:
                ...
                if C and C.DUPLICATE_YAML_DICT_KEY == 'warn':
                    Display().warning(msg)
                elif C and C.DUPLICATE_YAML_DICT_KEY == 'error':
...
AnsibleBaseConstructor.add_constructor(
    u'tag:yaml.org,2002:map',
    AnsibleBaseConstructor.construct_yaml_map)
...
AnsibleBaseConstructor.add_constructor(
    ...
    AnsibleBaseConstructor.construct_yaml_str)
...
AnsibleBaseConstructor.add_constructor(
    ...
    AnsibleBaseConstructor.construct_yaml_seq)

AnsibleBaseConstructor.add_constructor(
    u'!unsafe',
    AnsibleBaseConstructor.construct_yaml_unsafe)
